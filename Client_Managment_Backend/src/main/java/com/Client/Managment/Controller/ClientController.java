...
import com.Client.Managment.Domain.ClientListWrapper;
...
public class ClientController {
    ...
    @GetMapping("/clients")
    public ResponseEntity<ClientListWrapper> getAllClients(){
        List<Client> clients = clientService.findAllClients();
        return new ResponseEntity<>(new ClientListWrapper(clients), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ClientListWrapper> getClientByName(@PathVariable String clientName){
    ...
    public ResponseEntity<?> updateClient(@PathVariable Long id, @RequestBody Client client){
        if (id == null){
            throw new InvalidClientIdException("Id can't be null");
        }
